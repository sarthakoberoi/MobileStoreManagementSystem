...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        categorylabel.setText("Click on the user row to modify status.");
        jPanel1.add(categorylabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 560, -1, -1));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int a = JOptionPane.showConfirmDialog(null, "Do you want to change the status of "+email+" ?","Confirmation",JOptionPane.YES_NO_OPTION);
        if (a==0) {
